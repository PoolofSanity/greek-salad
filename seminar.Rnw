...
colnames(Summ) <- c("Undivided", "Divided")
#Print the Summary Stats
stargazer(Summ, title = "Summary Statistics in 2013", summary = NULL, digits = 1, notes = "Population figures used to calculate SchoolperPop2013 is from 2001")
...
colnames(Summ) <- c("Undivided", "Divided")
#Print the Summary Stats
stargazer(Summ, title = "Summary Statistics in 2005 - Using PS Matched Data", summary = NULL, digits = 1)
