...
fit.School <- lm(SchoolNo ~ Split*Post + Literacy + Data$YoungPop, Data)
fit.public <- lm(Public ~ Split*Post + Literacy + Data$YoungPop, Data)
fit.DevGrant <- lm(DevGrantR ~ Split*Post + Literacy + Data$YoungPop, Data)
fit.TLM <- lm(TLMGrantR ~ Split*Post + Literacy + Data$YoungPop, Data)
stargazer(fit.School, fit.public, fit.DevGrant, fit.TLM, digits = 1, df = FALSE)

#Infrastructure related variables
fit.Class <- lm(Classrooms ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.Toilet <- lm(ToiletG ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.Elect <- lm(Electricity ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.libr <- lm(Library ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
stargazer(fit.Class, fit.Toilet, fit.Elect, fit.libr, digits = 1, df = FALSE)

#Teaching resources related variables
fit.male <- lm(Male_Tch ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.fem <- lm(Female_Tch ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.grad <- lm(Grad_Tch ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.prof <- lm(ProfQ_Tch ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
stargazer(fit.male, fit.fem, fit.grad, fit.prof, digits = 1, df = FALSE)

#Organization related variables
fit.WDays <- lm(WorkDays ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.AcdInsp <- lm(AcadInsp ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.nonTch <- lm(Days_nonTch ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
fit.scores <- lm(TotalMarks ~ Split*Post + SchoolNo + Public + DevGrantR + TLMGrantR + Literacy + Data$YoungPop, Data)
