...
\paragraph{} It may also be possible that some of the positive effects do exist, but it may be manifesting not in higher service levels but in lower costs to achieve the same service level as before. The results do not suggest that district bifurcations are always inadvisable. But a more tempered approach might be warranted than the unbridled enthusiasm in their favour in the absence of clear evidence.
\printbibliography
\pagebreak
\section*{Appendix}
\begin{table}[h!]
...
\begin{landscape}
	...
	\end{landscape}
	% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
	% Date and time: Thu, Jul 14, 2016 - 1:53:09 PM
	\begin{table}[!htbp] \centering 
...
\end{table} % Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
	...
	% Date and time: Thu, Jul 14, 2016 - 1:53:10 PM
	\begin{table}[!htbp] \centering 
		\caption{} 
		\label{} \scalebox{0.9}{
	...
	\begin{table}[!htbp] \centering 
		...
		\end{tabular} }
	\end{table} % Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
	% Date and time: Thu, Jul 14, 2016 - 1:53:11 PM
	\begin{table}[!htbp] \centering 
		\caption{} 
		\label{} 
		\scalebox{0.9}{
